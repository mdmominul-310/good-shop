...
const showProducts = () => {
  ...
  for (const product of allProducts) {
    ...
    div.classList.add("product", "mx-3", "my-5", "card", "h-100", "shadow", "rounded");
    div.innerHTML = `<div class="card-body view zoom overlay z-depth-2 rounded">
    ...
    <span>(${product.rating.count})rated</span>
      ...
      <button onclick="productDetails(${product.id})" id="details-btn" class="btn btn-danger">Details</button>
    </div>
      </div>
      `;
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <ul class="rating ">
        ...
        <i class="far fa-star"></i>
        <i class="far fa-star"></i>
        <span>(${details.rating.count})rated</span>
      </ul>
      <p><span class="mr-1"><strong>$${details.price}</strong></span></p>
      <p class="pt-1" id="description">${details.description}</p>
      <hr>
